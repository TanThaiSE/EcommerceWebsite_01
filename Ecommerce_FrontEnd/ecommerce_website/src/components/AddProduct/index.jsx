...
import { apiUploadImage, apiAdmin, apiCategory } from '../../api';
...
const AddProduct = () => {
    ...
    const onSubmitCreateProduct = async (data) => {
        ...
        await apiAdmin.fetchCreateProduct(productCreate).then(async (res) => {
            let idProduct = res.data.dataResponse.id;
            let listImageInCloud = [];
            await apiAdmin.fetchCreateColorProduct({ listAttributes: selectedOptionColor, productId: idProduct }).then((res) => {
            }).catch((err) => console.log(err));
            await apiAdmin.fetchCreateSizeProduct({ listAttributes: selectedOptionSize, productId: idProduct }).then((res) => {
            }).catch((err) => console.log(err));
